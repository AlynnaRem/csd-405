...
public class AlynnaInteger {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(AlynnaInteger1.isEven(2));
        System.out.println(AlynnaInteger2.isOdd(17));
        System.out.println(AlynnaInteger3.isPrime(52));

        // Giving Integer as parameter
        System.out.println(AlynnaInteger1.isEven(Integer.valueOf(10)));
        System.out.println(AlynnaInteger2.isOdd(Integer.valueOf(4)));
        System.out.println(AlynnaInteger3.isPrime(Integer.valueOf(3)));
